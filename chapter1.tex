...
z     \begin{Theorem} \label{thm:逐点->一致}
	...
	\item $ f\in\CA\Longrightarrow \bar{f}\in\CA $.(也称$ \CA $是\textbf{自伴}的),
	\end{enumerate}
	则$ \CA $在$ C(K,\K) $中稠密.
	\end{Theorem}
	...
	\item 设$ (E,d) $是度量空间, $ (x_n)_{n\geqslant 1} $是$ E $中的Cauchy列, 并有$ A\subset E $. 假设$ A $的闭包$ \bar{A} $在$ E $中完备且有$ \lim\limits_{n\to\infty}d(x_n,A)=0 $. 证明: $ (x_n)_{n\geqslant 1} $在$ E $中收敛. (2.3)
