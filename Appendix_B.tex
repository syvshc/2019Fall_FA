...
\section{第3章习题(不完全)}
	...
	\[
	\begin{aligned}
	\int_\R\left(\int_\R f(x-y)g(y)\diff y \right)\diff x&=\int_\R g(y)\left(\int_\R f(x-y)\diff x\right)\diff y\\&=\int_\R g(y)\left(\int_\R f(x-y)\diff (x-y)\right)\diff y=\left(\int_\R f(u)\diff u\right)\left(\int_\R g(v)\diff v\right).
	\end{aligned}
	\]
